...
@section('body')
    <div id="site-configurations">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8">
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">News per page <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{Form::number('news_limit',@$data->news_limit,array('id'=>"news_limit",'class'=>"form-control col-md-7 col-xs-12"))}}
                </div>
            </div>
