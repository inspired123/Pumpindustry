...
@section('sIte_tItle',isset(Configurations::getConfig('site')->site_name) ? Configurations::getConfig('site')->site_name : '')
...
<!-- Header -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="{{skin('/images/header-iphone.png')}}" alt="alternative">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{skin('/images/testimonial-1.jpg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{skin('/images/testimonial-2.jpg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{skin('/images/testimonial-3.jpg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{skin('/images/testimonial-4.jpg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{skin('/images/testimonial-5.jpg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{skin('/images/testimonial-6.jpg')}}" alt="alternative">
                                        <div class="card-body">
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Image Pane -->
                                <div class="col-lg-4">
                                    <img class="img-fluid" src="{{skin('/images/features-iphone-1.png')}}" alt="alternative">
                                </div>
                                <!-- end of image pane -->
                    ...
                    <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Image Pane -->
                                <div class="col-md-4">
                                    <img class="img-fluid" src="{{skin('/images/features-iphone-2.png')}}" alt="alternative">
                                </div>
                                <!-- end of image pane -->
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Image Pane -->
                                <div class="col-md-4">
                                    <img class="img-fluid" src="{{skin('/images/features-iphone-3.png')}}" alt="alternative">
                                </div>
                                <!-- end of image pane -->
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                                <img class="img-fluid" src="{{skin('/images/video-frame.jpg')}}" alt="alternative">
    ...
    <div id="details" class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{skin('/images/details-1-iphone.png')}}" alt="alternative">
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
                        <h3>Goals Setting</h3>
        ...
        <div class="second">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="{{skin('/images/details-2-iphone.png')}}" alt="alternative">
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            </div> <!-- end of container -->
        </div> <!-- end of second -->
	...
	<div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
		<div class="row">
			...
			<div class="col-lg-6">
				<img class="img-fluid" src="{{skin('/images/details-lightbox-1.png')}}" alt="alternative">
			</div>
			<div class="col-lg-6">
				<h3>Goals Setting</h3>
				<hr>
    ...
    <div id="details-lightbox-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
		<div class="row">
			<button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
			<div class="col-lg-6">
				<img class="img-fluid" src="{{skin('/images/details-lightbox-2.png')}}" alt="alternative">
			</div>
			<div class="col-lg-6">
				<h3>Calendar Input</h3>
				<hr>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-1.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-1.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-2.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-2.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-3.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-3.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-4.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-4.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-5.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-5.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-6.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-6.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-7.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-7.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-8.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-8.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-9.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-9.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="images/screenshot-10.png" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{skin('/images/screenshot-10.png')}}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{skin('/images/download.png')}}" alt="alternative">
