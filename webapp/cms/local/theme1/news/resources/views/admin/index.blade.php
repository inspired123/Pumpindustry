...
@section('body')
    <div class="table-div">
        <a class="btn btn-default btn-sm hor-align pull-right btn-right-spacing" href="{{route('news.create')}}" ><i class='glyphicon glyphicon-plus-sign'></i>&nbsp;&nbsp;New</a>

        <a class="btn btn-default btn-sm hor-align pull-right btn-right-spacing" href="{{route('update-news')}}" ><i class='glyphicon glyphicon-refresh'></i>&nbsp;&nbsp;Update news</a>
...
@section('script')
    <script>
        $('document').ready(function(){
            ...
            var url =  '{{route('get_news_data_from_admin')}}';
            var column = [
                ...
                { data: 'is_bot', name: 'is_bot' , className: 'textcenter' , render: function(data) {
                    return (data == 1) ? 'Yes' : 'No';
                }},
                { data: 'is_video', name: 'is_video' , className: 'textcenter', render: function(data) {
                    return (data == 1) ? 'Yes' : 'No';
                }},
