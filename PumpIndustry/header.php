			  ...
			  <header id="header" id="home">
		  			...
		  			<div class="container">
				  		<div class="row">
				  			...
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
				  				<a href="tel:+880 012 3654 896">+91   9000303003 </a>
				  				<a href="mailto:krishnareddyk@yahoo.com">krishnareddyk@yahoo.com</a>				
				  			</div>
				  		</div>			  					
		  			</div>
				</div>
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="../"><img src="../img/Pump-Industry-logo.jpg" alt="" title="" / style="height: 50px;"></a>
				      </div>
