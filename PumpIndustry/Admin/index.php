    ...
    <div class="registration-form">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <div class="form-group">
            <label>Email:</label>
            <input type="text" class="form-control"  placeholder="Enter Email" name="email" value="superadmin@gmail.com">
            <p class="err-msg">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control"  placeholder="Enter Password" name="password" value="admin123">
            <p class="err-msg">
